...
parser.add_argument('--mod_name', type=str, default='clof_4ReLU_', help='choice the model you want to use')
...
class HiCFormer:
    def __init__(self, cell_Line='Human', cellNo=10, res=40000, model=args.mod_name, batch_size=1):
        ...
        self.device = device
        self.mod_name = model+str(args.epochs-1)+'eps'
...
if __name__ == "__main__":
    train_model = HiCFormer(cell_Line='Human', cellNo=10, res=200000)
