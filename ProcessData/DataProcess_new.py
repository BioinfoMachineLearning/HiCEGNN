...
class HiCdata_n(Dataset):
    def __init__(self,
        ...
        if cell_line == "Human":
            ...
            self.dirname = str(root) + "/Data/GSE131811"
            self.dirname_ful = str(root) + "/DataFull/GSE131811_" + cell_line + "_cell" + str(cell_No)
        ...
        if full == True:
            ...
            if cell_line == "Human":
                ...
                if tvt == "train":
                    ...
                    self.chros = [2, 6, 10, 12]  # original is [4, 14, 18, 20]
                elif tvt == "test":
                    self.chros = [4, 14, 18, 20]  # original is [2, 6, 10, 12]
...
if __name__ == "__main__":
    Loader = HiC_noise_Loader(cellno = 10, celline = 'Human', tvt='test', res=500000, lstm=False, noise_level='low')
    # Loader = HiC_Loader(cellno=10, celline='Human', tvt='test', res=500000, lstm=False)
