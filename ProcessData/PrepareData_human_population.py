...
def loadBothConstraints(stria, strib, res):
    ...
    per_a       = np.percentile(mata, 99.0)   # for population its 99.0; for single cell its 99.99
    ...
    per_b       = np.percentile(matb, 99.0)   # for population its 99.0; for single cell its 99.99
...
if __name__ == '__main__':
    obj = GSE131811Module(cell_No = 21, res = 320000)    # # GSE131811() for Drosophila cell21/22, GSE130711() for Human cell10
    obj.prepare_data()
